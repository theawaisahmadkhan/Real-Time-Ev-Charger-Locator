...
path('addstationdetailshome',views.addstationdetailshome,name="addstationdetailshome"),
...
path('filteradmin',views.filteradmin,name="filteradmin"),
...
path('filterdistanceadmin',views.filterdistanceadmin,name="filterdistanceadmin"),
...
path('homeloginuser',views.homeloginuser,name="homeloginuser"),

path('loginstationuser',views.loginstationuser,name='loginstationuser'),
path('loginhomeuser',views.loginhomeuser,name='loginhomeuser'),
